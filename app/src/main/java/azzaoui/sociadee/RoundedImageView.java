...
public class RoundedImageView extends ImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Bitmap or = blur(ors, 5, (int)(0.3 * ors.getHeight()));
    ...
    public Bitmap blur(Bitmap sentBitmap, int radius, int h) {
        ...
        int[] pix = new int[w * h];
        bitmap.getPixels(pix, 0, w, 0, height-h, w, h);
        ...
        bitmap.setPixels(pix, 0, w, 0, height-h, w, h);
